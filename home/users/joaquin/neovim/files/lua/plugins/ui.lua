      ...
      options = {
        ...
        diagnostics_indicator = function(_, _, diagnostics_dict)
          local ret = (
            ...
            .. (
              diagnostics_dict.warning and diagnostics_signs[vim.diagnostic.severity.WARN] .. diagnostics_dict.warning
              or ""
            )
          return vim.trim(ret)
        end,
  ...
  },
  {
    ...
    init = function()
      U.lsp.on_attach(function(client, buffer)
        ...
        local prev_client = vim.b[buffer].navic_client_name

        if not prev_client or client.name == prev_client then
          return
        end
